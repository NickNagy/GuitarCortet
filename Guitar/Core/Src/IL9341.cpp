...
void ILI9341_invertRows(uint16_t y0, uint16_t y1) {
	...
	ILI9341_SendCommand(ILI9341_PARTIAL_MODE_ON);
	/* invert area */
	ILI9341_SendCommand(ILI9341_DISPLAY_INVERSION_ON);
}
...
void ILI9341_printText(std::string text, uint16_t x, uint16_t y, uint16_t color, uint16_t bg, uint8_t size)
{
	int16_t offset;
	offset = size*6;
